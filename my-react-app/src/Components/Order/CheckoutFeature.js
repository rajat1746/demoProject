    ...
    <Grid item xs={4}>
      <Item>
        ...
        {selectedItems.map((item) => (
          <div key={item.attributes.id} style={{ marginBottom: "8px", width: "100%" }}>
            ...
            >
              ...
              <div style={{alignItems:"center",display:"flex",justifyContent:"space-between",width:"80%"}}>
              <Typography  variant="body2">{item.attributes.menu_name}</Typography>
              <Typography  variant="body2">{item.attributes.menu_price}</Typography>
              </div>
              </div>
              <div style={{ flexGrow: 1, textAlign: "left" }}>
              <Typography variant="body2">{item.attributes.menu_description}</Typography>
